...
void DialogLayer::initDialog()
{
    ...
    Sprite* plabel = Sprite::create(pause_PATH+string("plabel.png"));
    //设置精灵对象的位置
    ...
    //叉号——1
	x_1 = Sprite::create(pause_PATH+string("x.png"));
	//设置精灵对象的位置
	...
	//叉号——2
	x_2 = Sprite::create(pause_PATH+string("x.png"));
	//设置精灵对象的位置
	...
	(
		 pause_PATH+string("resume.png"), 		//平时的图片
		 pause_PATH+string("resume3.png"),  	//选中时的图片
		 //点击菜单按钮时执行的回调方法
	...
	(
		 pause_PATH+string("p.png"), 	//平时的图片
		 pause_PATH+string("p.png"),  	//选中时的图片
		 //点击时执行的回调方法
	...
	(
		 pause_PATH+string("s.png"), 	//平时的图片
		 pause_PATH+string("s.png"), 	//选中时的图片
		 //点击时执行的回调方法
    ...
    //创建回主菜单的精灵
   	...
   	(
   		pause_PATH+string("exit.png"), 		//平时的图片
   		pause_PATH+string("exit3.png"),  	//选中时的图片
   		//点击时执行的回调方法
