...
Weapon* Weapon::create(int id)
{
	...
	Weapon* temp = new Weapon();
	//定义一个存放一级防御塔的字符串数组
	std::string picTable[4] = {"pic/white_1.png","pic/green_1.png","pic/red_1.png","pic/blue_1.png"};
	//初始化安装防御塔时金币的消耗
	int sValue[4]={15,25,30,50};
	//四种防御塔从1级升级到2级时的金币消耗
...
Weapon* Weapon::create(int id,int level,float angle)
{
	//创建一个对象
	Weapon* temp = new Weapon();
	std::string picTable[4][3] = {{"pic/white_2.png","pic/white_3.png","pic/white_4.png"},
