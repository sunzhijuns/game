...
bool AchieveLayer::init()
{
    ...
    //创建一个精灵对象，充当欢迎界面的背景
    backSprite = Sprite::create(rankinglist_PATH+string("background.png"));
    //设置精灵对象的位置
    ...
    //创建一个精灵对象，“排行榜”
    Sprite *playSprite = Sprite::create(rankinglist_PATH+string("paihang.png"));
	//设置精灵对象的位置
    ...
    //创建一个表示颁奖台的精灵对象
    Sprite *paihangSprite = Sprite::create(rankinglist_PATH+string("paihang1.png"));
	//设置精灵对象的位置
    ...
    //创建一个精灵对象，“最高分数”
    Sprite *paih1Sprite = Sprite::create(rankinglist_PATH+string("paih1.png"));
	//设置精灵对象的位置
    ...
    //创建一个精灵对象，“最高分数”
	Sprite *paih2Sprite = Sprite::create(rankinglist_PATH+string("paih2.png"));
	//设置精灵对象的位置
    ...
    //创建一个精灵对象，“最高分数”
	Sprite *paih3Sprite = Sprite::create(rankinglist_PATH+string("paih3.png"));
	//设置精灵对象的位置
	...
	for(int i = 0; i<3; i++)
	{
		...
		//分数
		labels = Label::createWithTTF (score, "fonts/Marker Felt.ttf", 45, Size::ZERO, TextHAlignment::LEFT, TextVAlignment::TOP);
	...
	(
		rankinglist_PATH+string("fanhui.png"),
		rankinglist_PATH+string("fanhui.png"),
